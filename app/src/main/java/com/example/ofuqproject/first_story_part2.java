...
public class first_story_part2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_first_story_part2);
        ...
        img_arrow_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent (first_story_part2.this , first_story.class);
                startActivity(i);
            }
        });
        ...
        img_arrow_forword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent (first_story_part2.this , second_story.class);
                startActivity(i);
            }
        });
    }
