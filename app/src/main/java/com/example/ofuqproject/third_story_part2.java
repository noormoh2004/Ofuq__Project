...
public class third_story_part2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_third_story_part2);
        ...
        img_arrow_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent (third_story_part2.this , third_story.class);
                startActivity(i);
            }
        });
        ...
        img_arrow_forword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent (third_story_part2.this , fourth_story.class);
                startActivity(i);
            }
        });
