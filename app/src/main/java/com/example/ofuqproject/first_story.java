...
public class first_story extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_arrow_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent (first_story.this , storis_library.class);
                startActivity(i);
            }
        });
        ...
        img_arrow_forword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent (first_story.this , first_story_part2.class);
                startActivity(i);
            }
        });
