...
public class fourth_story extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.fourth_story);
        ...
        img_arrow_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i =new Intent (fourth_story.this , third_story_part2.class);
                startActivity(i);
            }
        });
        ...
        img_arrow_forword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i =new Intent (fourth_story.this , fourth_story_part2.class);
                startActivity(i);
            }
        });
